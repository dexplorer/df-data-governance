...
def run_data_quality_task(required_parameters: dict, cycle_date: str) -> list[dict]:
...
def run_data_quality_ml_task(required_parameters: dict, cycle_date: str) -> list[dict]:
    dataset_id = required_parameters["dataset_id"]
...
def run_data_profile_task(required_parameters: dict, cycle_date: str) -> list[dict]:
    dataset_id = required_parameters["dataset_id"]
...
def run_data_recon_task(required_parameters: dict, cycle_date: str) -> list[dict]:
    dataset_id = required_parameters["dataset_id"]
    logging.info(
...
def run_data_lineage_task(workflow_id: str, cycle_date: str) -> list[dict]:
    logging.info("Start capturing data lineage for the workflow %s", workflow_id)
    ...
    logging.info("Finished capturing data lineage for the workflow %s", workflow_id)

    return dl_relationships


def run_management_tasks(tasks: list[wf.ManagementTask], cycle_date: str) -> list[dict]:
    mgmt_task_results = []
    for task in tasks:
